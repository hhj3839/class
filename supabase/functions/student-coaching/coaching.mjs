...
최근 고민·도움 요청에 어려움을 표현하지 않았고 별도의 안전 호소가 없다면, question은 '요즘 학교에서 좋았거나 기억에 남는 일이 있니?'처럼 일상의 경험을 열어 두고 묻습니다. '고민이 없다고 했는데'를 반복하거나 없는 문제를 찾아내려고 묻지 마세요. 좋았던 일이 반드시 있었다고 전제하지도 마세요.
actions는 좋았던 경험이나 기억에 남는 일을 이야기할 때 그 경험에서 무엇이 좋았는지·본인이 중요하게 여기는 것을 알아보는 대화를 포함할 수 있습니다. 학생이 바라는 변화나 어려움을 실제로 말할 때만 해결 방법 탐색으로 이어지며, 모든 이야기를 개선 목표로 바꾸지 마세요.
이전 자기평가의 낮은 점수나 이유를 끌어와 준비물·경청·공부 문제를 이번 대화의 필수 주제로 만들지 마세요. 학생이 그 주제를 꺼냈을 때만 연결할 수 있고, 특정 어려움을 제목에 명시한다면 실제 해당 문항 근거가 필요합니다. 최근 '없음' 응답과 무관한 과거 어려움보다 학생이 지금 고른 이야기를 우선하세요.
바라는 변화나 시도가 아직 없다면 check_after는 '오늘 나눈 이야기만으로 마쳐도 괜찮습니다. 학생이 나중에 바라는 변화나 해 보고 싶은 일을 말할 때만 함께 살펴보세요.'처럼 짧은 마무리 안내를 쓰세요. 이때 '선택할 때:'·'실제로 해 본 뒤:' 두 줄은 강제하지 않습니다. 즐거운 경험을 알아보거나 대화를 마치는 것도 충분하며 실천 과제를 만들지 마세요.
이 원칙은 안전 호소를 무시하는 분류 규칙이 아닙니다. 다른 문항에 폭력·괴롭힘·즉각적인 도움 요청이 있으면 아래 안전 우선 규칙을 적용하세요.
...
입력: 최근 고민 '없음', 도움 요청 '지금은 괜찮아요' 선택. 별도 안전 호소 없음.
첫 질문: '요즘 학교에서 좋았거나 기억에 남는 일이 있니?'
기억에 남는 일을 말하면: '그 일에서 너에게 기억에 남는 건 어떤 부분이야?' 실제 답을 듣고 그 학생에게 의미 있는 것을 알아봅니다.
바라는 변화가 있다면: 학생이 고른 주제를 되짚어 확인하고 원할 때만 방법을 함께 탐색합니다.
마무리: 오늘 이야기만으로 마쳐도 됩니다. 바라는 변화가 없으면 다음 과제나 실천 약속을 정하지 않습니다.
