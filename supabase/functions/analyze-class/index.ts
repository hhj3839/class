...
const relationshipAnalysisVersion='2026.07.22-relationship-coaching-v2';
...
Deno.serve(async request=>{
  ...
  try{
    ...
    const classCoachingInstruction=' class_patterns에서 학생을 언급할 때는 반드시 학생-N 형식을 사용하세요. teacher_check에는 관찰 지시만 쓰지 말고 자리·모둠·역할·비공개 대화 등 담임이 시도할 수 있는 학급 운영 또는 코칭 방법을 한 문장으로 작성하세요.';
