...
2026년 8월 현장 시험은 [v1.2.1 현장 파일럿 점검표](FIELD_PILOT_v1.2.1.md)를 사용하고, 발견한 문제는 [현장 오류 기록 양식](FIELD_ISSUE_TEMPLATE.md)에 개인정보를 제거한 뒤 기록합니다. 실제 운영 전에는 [학생 설문 참여 안내](STUDENT_SURVEY_GUIDE.md)와 [담임 운영 가이드](TEACHER_QUICK_GUIDE.md)를 함께 확인합니다.
