...
test('관계 AI는 월별 변화와 누적 익명 관계 계산을 함께 받아 학급 운영 문장을 생성한다',()=>{
  ...
  assert.match(edge,/relationship-coaching-v4/);
  assert.match(edge,/latest_month_summary/);
...
test('관계 AI 카드는 핵심 제목과 근거 범위를 먼저 표시한다',()=>{
