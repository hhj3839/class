...
const {calendarMonths,academicYearMonths}=require('../student-calendar.js');
...
test('달력은 교사 관찰 상태를 불러오지 않는다',()=>{
 assert.equal(require('../student-calendar.js').observationMonthState,undefined);
});
