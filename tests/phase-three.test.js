...
test('배포 HTML은 최신 앱·인증·파일럿 스타일 캐시 버전을 사용한다',()=>{
  ...
  assert.match(html,/analysis-dashboard\.css\?v=20260722-5/);
  assert.match(html,/app\.js\?v=20260722-12/);
  assert.match(html,/student-support-timeline\.css\?v=20260722-1/);
  assert.match(html,/student-support-timeline\.js\?v=20260722-2/);
  assert.match(html,/student-record\.css\?v=20260722-1/);
...
test('학생 관계 선택 접근성 문구는 이름 받침에 맞는 조사를 사용한다',()=>{
  ...
  assert.match(fs.readFileSync('student.html','utf8'),/student\.js\?v=20260722-1/);
});
