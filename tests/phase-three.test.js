...
test('배포 HTML은 최신 앱·인증·파일럿 스타일 캐시 버전을 사용한다',()=>{
  ...
  assert.match(html,/app\.js\?v=20260724-29/);
    assert.match(html,/student-support-timeline\.css\?v=20260724-4/);
    assert.match(html,/student-support-timeline\.js\?v=20260724-7/);
